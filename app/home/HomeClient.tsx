            ...
            >
              <div className="relative w-20 h-20 mx-auto mb-4 rounded-full overflow-hidden">
                <Image
                  ...
                  alt={`صورة ${testimonials[currentTestimonial].name} - عميل Town Bakery`}
                  fill
            ...
            <div className="flex justify-center gap-2 mt-6" role="tablist" aria-label="شهادات العملاء">
              {testimonials.map((_, idx) => (
                <button
                  ...
                  aria-label={`عرض شهادة ${idx + 1} من ${testimonials.length}`}
            ...
            {[1, 2, 3, 4, 5, 6, 7, 8].map((idx) => (
              ...
              >
                <Image
                  ...
                  alt={`معرض مخبز تاون - صورة ${idx} من معرض المنتجات الطازجة`}
                  fill
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <Image
                ...
                alt="مخبز Town Bakery - مخبزنا الدافئ مع المخبوزات الطازجة"
                fill
                className="object-cover"
                loading="lazy"
              />
